...
class _OtpPageState extends State<OtpPage> {
  ...
  Future<void> _verifyOtp(String verificationId, String phoneNumber, String? email, String? username, String? password, String? userId, PhoneAuthCredential? autoCredential) async {
        ...
        if (email != null && username != null && password != null) {
          ...
          if (response.statusCode == 200) {
            ...
            if (responseData['statusCode'] == 200) {
              ...
              CustomSnackBar.show(context, message: 'Registration successful!', borderColor: const Color(0xFF9146FF));
  ...
  Future<void> _resendOtp(String phoneNumber, String userId, String? email, String? username, String? password) async {
    setState(() {
      _isResending = true;
      _errorMessage = null;
    });
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: ElevatedButton(
                                onPressed: _isLoading || _isResending
                                    ? null
                                    : () => _resendOtp(phoneNumber, userId ?? '', email, username, password),
                            ...
                            Expanded(
                              child: ElevatedButton(
                                onPressed: _isLoading || _isResending
                                    ? null
                                    : () => _verifyOtp(verificationId, phoneNumber, email, username, password, userId, autoCredential),
                                style: ElevatedButton.styleFrom(
                        ...
                        const SizedBox(height: 12),
                        TextButton(
                          onPressed: _isLoading || _isResending ? null : () => Navigator.pop(context),
